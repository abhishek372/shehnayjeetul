...
document.querySelector (".drop-down #open-dropdown").addEventListener ("click", function () {
    document.querySelector ("#dropss").style.display = "flex";
})

document.querySelector ("#dropss #close-drop-list").addEventListener ("click", function () {
